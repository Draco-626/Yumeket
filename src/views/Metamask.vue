  ...
  methods: {
    onComplete(data) {
      ...
      if (data.type === "USER_DENIED_ACCOUNT_AUTHORIZATION") {
        ...
        this.errordesc =
          "The authorization was denied, we didn't get any information, please try to reauth with Metamask";
      } else if (data.type === "NO_INSTALL_METAMASK") {
        this.dialog = true;
        this.errortitle = "Metamask not found";
        this.errordesc =
          "Can't find Metamask, is it installed correctly? If Metamask is running correctly, please try restarting your browser.";
        ...
        this.errortitle = "Metamask not found";
        this.errordesc =
          "Metamask is not logged in, please initialise the wallet or restore it and try again";
      } else {
